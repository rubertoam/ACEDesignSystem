...
const fieldTriggerClass = cn(
  'inline-flex w-[var(--ace-time-picker-trigger-width)] max-w-[var(--ace-time-picker-trigger-width)] shrink-0 items-center justify-between gap-[var(--space-2)] rounded-[var(--radius-sm)] border border-solid border-[var(--screening-border-strong)] bg-[var(--screening-surface)] px-3 py-2 text-sm font-normal leading-[1.65] text-[var(--screening-text-primary)] outline-none transition-colors [font-family:var(--font-screening)]',
