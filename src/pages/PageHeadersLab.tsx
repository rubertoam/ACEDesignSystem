...
import {
  LabCheckbox,
  LabRadioGroup,
  labControlLegendClass,
} from '../lib/labControls'
...
export function PageHeadersLab() {
  ...
  const [layout, setLayout] = useState<AceSubHeaderLayout>('full')
  ...
  return (
    <ComponentLabPage
      title="Page Headers"
      description="Application page header (Review Assigned) and composable sub-header for full-page or split-screen content regions."
      examplesToolbar={
        ...
        <>
          <section className={labUsageSectionClass}>
            ...
            <p className="m-0 text-[var(--screening-text-muted)]">
              ...
              <code className="text-[var(--screening-text-primary)]">AceSiteHeader</code> for the page title (e.g.
              Review Assigned). Use{' '}
              <code className="text-[var(--screening-text-primary)]">AceSubHeader</code> below it for region-level
              chrome — full-page or split-screen — with optional statistics, paging, more menu, or drill-down.
            </p>
          </section>
          <section className={labUsageSectionClass}>
